...
public class BookCarStepDef {
	...
	@When("^User enters the pickup and dropoff pickup time and dropoff time pickup date and dropoff date$")
	...
	public void user_select_car() throws Throwable {
